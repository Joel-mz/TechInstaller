...
# =============================================================================
# PASO 1: CARGAR M?DULOS DEL PROYECTO Y WPF
# =============================================================================
...
# L?gica para encontrar los programas si no est?n en la carpeta local (ej: si se descarg? en AppData)
    ...
    <Grid>
        ...
        <Border Grid.Column="0" Background="#1E293B">
            <StackPanel>
                ...
                <TextBlock Text="MENU PRINCIPAL" Foreground="#64748B" FontSize="11" FontWeight="Bold" Margin="20,10,20,10" />
        ...
        <Grid Grid.Column="1" Margin="30,20,30,20">
            ...
            <StackPanel Grid.Row="0">
                <TextBlock Text="CATEGORIAS" Foreground="#94A3B8" FontSize="12" FontWeight="Bold" Margin="0,0,0,15" />
        ...
        <Border Grid.Column="2" Background="#111827" BorderThickness="1,0,0,0" BorderBrush="#1E293B">
            <StackPanel Margin="25">
                <TextBlock Text="ACCI?N R?PIDA" Foreground="#94A3B8" FontSize="12" FontWeight="Bold" Margin="0,0,0,20" />
                ...
                <TextBlock Text="INFORMACION" Foreground="#94A3B8" FontSize="12" FontWeight="Bold" Margin="0,15,0,20" />
                ...
                <Grid Margin="0,0,0,15">
                    <TextBlock Text="Ultima actualizacion:" Foreground="#CBD5E1" />
...
$MenuCategories.Add_SelectionChanged({
    if ($MenuCategories.SelectedItem) {
        $script:CategoriaSeleccionada = $MenuCategories.SelectedItem.Tag
        $TxtSearch.Text = "" 
        
        if ($script:CategoriaSeleccionada -eq "Todos" -or $script:CategoriaSeleccionada -eq "Inicio") {
            $ProgramList.ItemsSource = $script:ListaProgramas
        } else {
            $filtrados = $script:ListaProgramas | Where-Object { #Requires -Version 5.1
[CmdletBinding()]
param([switch]$NoAdmin)
...
.Categoria -eq $script:CategoriaSeleccionada }
            $ProgramList.ItemsSource = $filtrados
        }
    }
})
